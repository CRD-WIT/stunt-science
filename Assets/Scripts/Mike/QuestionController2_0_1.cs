...
public class QuestionController2_0_1 : MonoBehaviour
{
    float playerAnswer;
    ...
    public string answerUnit,
        difficulty;
    public HeartManager2 heartManager;
    int passedLevel;
    ...
    GameObject modalComponentHorizontal,
        popupComponentHorizontal,
        playButtonHorizontal,
        timerComponentHorizontal,
        problemBoxHorizontal,
        problemTextHorizontal,
        modalTextHorizontal,
        modalTitleHorizontal,
        wrongIconHorizontal,
        correctIconHorizontal;
    ...
    void Start()
    {
        ...
        {
            baseComponent,
            modalComponentHorizontal.transform,
            extraComponent
        };
        problemBox = baseComponent.Find("ProblemBox");
        stageName = problemBox.Find("StageBar3").Find("StageName");
        ...
        heartManager = FindObjectOfType<HeartManager2>();
    }
    ...
    public void ActivateResult(string message, bool isCorrect, bool isComplete = false)
    {
        ...
        {
            //TODO: Check current heartManager points. If heartManager == 0, hide the action button.
            if (heartManager.life == 0)
            {
                actionBtn.transform.Find("BtnName").GetComponent<TMP_Text>().text = "End Game";
