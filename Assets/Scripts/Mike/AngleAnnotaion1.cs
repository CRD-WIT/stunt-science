...
public class AngleAnnotation1 : MonoBehaviour
{
    [SerializeField] TextColorMode lineColor;
    float angle, x, y, xSL, ySL, angle1, x1, y1, angle2, x2, y2, marginOfError = 0.00001f;
    ...
    void LineSetting()
    {
        ...
        if ((angleA / Mathf.Abs(angleA)) == 1)
        {
            ...
            if ((angleC + marginOfError) == 90.00001)
                angleC = 90;
