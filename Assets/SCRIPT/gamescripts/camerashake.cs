...
public class camerashake : MonoBehaviour
{
    ...
    IEnumerator fallingrubble()
    {
        ...
        TempGo2.transform.position = new Vector2(Random.Range(-3, 20), 3.5f);
         GameObject TempGo3 = Instantiate(rubbles[Random.Range(0, 1)]);
        TempGo3.transform.position = new Vector2(Random.Range(-3, 20), 3.5f);
         GameObject TempGo = Instantiate(rubbles[Random.Range(0, 1)]);
        TempGo.transform.position = new Vector2(Random.Range(-3, 20), 3.5f);
        rubbleON = false;
    ...
    IEnumerator debrisFall()
    {
        ...
        TempGo2.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        GameObject TempGo7 = Instantiate(debris[Random.Range(0, 2)]);
        TempGo7.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        GameObject TempGo6 = Instantiate(debris[Random.Range(0, 2)]);
        TempGo6.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        yield return new WaitForSeconds(0.3f);
         GameObject TempGo3 = Instantiate(debris[Random.Range(0, 2)]);
        TempGo3.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        GameObject TempGo5 = Instantiate(debris[Random.Range(0, 2)]);
        TempGo5.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        yield return new WaitForSeconds(0.3f);
         GameObject TempGo = Instantiate(debris[Random.Range(0, 2)]);
        TempGo.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
        GameObject TempGo4 = Instantiate(debris[Random.Range(0, 2)]);
        TempGo4.transform.position = new Vector2(Random.Range(-3, debrisRange), 3.5f);
