public static class Actions
{
    ...
    public static string UnmutedSound = "UnmutedSound";
    public static string AdjustedMusicVolume = "AdjustedMusicVolume";
    public static string ViewedCredits = "ViewedCredits";
